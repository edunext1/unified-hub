...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Dashboard — OrbitOps" },
      { name: "description", content: "Operational overview: KPIs, channel performance, bookings and team activity in one view." },
    ],
  }),
  component: Dashboard,
});
              ...
              return (
                ...
                >
                  ...
                  >
                    {pinned ? (
                      <>
                        <BookmarkCheck className="h-4 w-4" /> Pinned
                      </>
                    ) : (
                      <>
